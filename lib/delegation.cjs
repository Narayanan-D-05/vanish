...
class DelegationManager {
  ...
  async executeDelegatedTransfer(ownerAccountId, recipientAccountId, amountHbar) {
    ...
    // Check if the operator of the client is the owner (same account testing/dev)
